...
const shippingAddressDefaultValues =
        ...
        <div className='md:col-span-3'>
          ...
          <div className='border-y'>
            {isPaymentMethodSelected && paymentMethod ? (
              ...
              <>
                <div className='flex text-primary text-xl font-bold my-2'>
                  <span className='w-8'>2 </span>
  ...
  <ul>
    <RadioGroup
      ...
      onValueChange={(value) =>
        setDeliveryDateIndex(
          AVAILABLE_DELIVERY_DATES.findIndex((address) => address.name === value)!
        )
      }
    >
      {AVAILABLE_DELIVERY_DATES.map((dd) => (
        <div key={dd.name} className="flex items-start space-x-2 mb-2">
          <RadioGroupItem
            value={dd.name}
            id={`address-${dd.name}`}
            className="mt-1"
