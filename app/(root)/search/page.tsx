...
import ProductSortSelector from '@/components/ui/shared/product/product-sort-selector'
import { getFilterUrl, toSlug } from '@/lib/utils'
import Rating from '@/components/ui/shared/product/rating'

import CollapsibleOnMobile from '@/components/ui/shared/collapsible-on-mobile'
        ...
        <div className='flex items-center text-lg '>
          ...
          price !== 'all' ? (
            <Button variant={'link'} asChild>
              <Link href='/search' className='text-xl'>Clear All Filters</Link>
            </Button>
          ) : null}
        </div>
        <div>
      ...
      <div className='bg-card grid md:grid-cols-5 md:gap-4'>
        <CollapsibleOnMobile title='Filters'>
          <div className='space-y-4'>
            ...
            <div>
              <div className='font-bold text-xl'>Customer Review</div>
              <ul>
                <li>
                  <Link
