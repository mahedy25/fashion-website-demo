...
export const SettingInputSchema = z.object({
  common: z.object({
    ...
    freeShippingMinPrice: z.coerce.number().min(0).optional(),
  ...
  carousels: z.array(CarouselSchema).optional(),
  defaultLanguage: z.string().optional(),
  availableCurrencies: z.array(SiteCurrencySchema).optional(),
  defaultCurrency: z.string().optional(),
  availablePaymentMethods: z.array(PaymentMethodSchema).optional(),
  defaultPaymentMethod: z.string().optional(),
  availableDeliveryDates: z.array(DeliveryDateSchema).optional(),
  defaultDeliveryDate: z.string().optional(),
})
